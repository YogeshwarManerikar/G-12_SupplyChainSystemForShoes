...
<label for="validationCustom03">Category(M W K U) </label>
...
<input type="text" class="form-control" id="validationCustom03" value="" name="productname" required>
...
<input type="text" class="form-control" id="validationCustom03" value="" name="productprice" required>
