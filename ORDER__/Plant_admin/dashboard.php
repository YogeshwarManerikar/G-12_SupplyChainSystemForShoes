...
<span class="d-block display-4 text-dark mb-5"> M W K U        </span>
...
<div class="d-flex justify-content-between mb-5">
<div>
<span class="d-block font-15 text-dark font-weight-500">Most demandaded Categorie</span>
</div>
<div>
</div>
</div>
...
<div class="text-center">
<span class="d-block display-4 text-dark mb-5"><span class="counter-anim">   M   </span></span>
<small class="d-block">Im demand </small>
</div>
</div>
</div>
</div>
...
<div class="d-flex justify-content-between mb-5">
<div>
<span class="d-block font-15 text-dark font-weight-500">Today's Orders</span>
</div>
<div>
</div>
</div>
...
<small class="d-block">Today's Total Orders</small>
</div>
</div>
</div>
</div>
...
<?php
//$quryss1=mysqli_query($con,"select sum(Quantity) as tt  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId where date(tblorders.InvoiceGenDate)=CURDATE()");
//$rws=mysqli_fetch_array($quryss1);
?>
<div class="col-lg-3 col-md-6">
<div class="card card-sm">
<div class="card-body">
<div class="d-flex justify-content-between mb-5">
<div>
<span class="d-block font-15 text-dark font-weight-500">Today's  demanded Product</span>
</div>
<div>
</div>
</div>
<div class="text-center">
<span class="d-block display-4 text-dark mb-5"><?php //echo number_format($rws['tt'],2);?></span>
<small class="d-block">Today's </small>
</div>
</div>
</div>
</div>
