...
<h3 class="mb-35 font-weight-600">    BATA </h3>
<h6 class="mb-5">Supply Chain Management System</h6>
</div>
...
<h4 class="mb-35 font-weight-600">Invoice of Demand</h4>
...
<span class="d-block">Seller #<span class="pl-10 text-dark"><?php //echo $row['CustomerName'];?></span></span>
<span class="d-block">Seller Location #<span class="pl-10 text-dark"><?php //echo $row['CustomerContactNo'];?></span></span>
<span class="d-block">Payment Status #<span class="pl-10 text-dark"><?php //echo $row['PaymentMode'];?></span></span>
</div>
</div>
</div>
