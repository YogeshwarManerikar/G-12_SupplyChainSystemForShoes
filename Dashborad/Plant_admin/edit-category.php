...
<input type="text" class="form-control" id="validationCustom03" value="" name="category" required>
...
<input type="text" class="form-control" id="validationCustom03" value="" name="categorycode" required>
